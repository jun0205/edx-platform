...
class EntitlementViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if support_details:
            for support_detail in support_details:
                parsed_details = ast.literal_eval(support_detail)
    ...
    def partial_update(self, request, *args, **kwargs):
        ...
        for support_detail in support_details:
            parsed_details = ast.literal_eval(support_detail)
            parsed_details['entitlement'] = entitlement
            parsed_details['support_user'] = request.user
            unenrolled_run_id = parsed_details.get('unenrolled_run', None)
